...
async function readWhite(){
    ...
    let boardLabel = [];
    let tempData;
    await fetch("./svm/datasets/white-dataset.txt")
...
async function readBlack(){
    ...
    let boardLabel = [];
    let tempData;
    await fetch("./svm/datasets/black-dataset.txt")
    .then((response)=>response.text())
    .then((data)=>{
        tempData = data.replace(/(\n)/gm, ':').replace(/(\r)/gm, '').split(':');
    });
...
async function readTestWhite(){
    ...
    let boardLabel = [];
    let tempData;
    await fetch("./svm/datasets/white-accuracy-test.txt")
    .then((response)=>response.text())
    .then((data)=>{
        tempData = data.replace(/(\n)/gm, ':').replace(/(\r)/gm, '').split(':');
    });
...
async function readTestBlack(){
    ...
    let boardLabel = [];
    let tempData;
    await fetch("./svm/datasets/black-accuracy-test.txt")
    .then((response)=>response.text())
    .then((data)=>{
        tempData = data.replace(/(\n)/gm, ':').replace(/(\r)/gm, '').split(':');
    });
